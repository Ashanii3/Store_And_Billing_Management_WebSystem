...
<body>
    ...
    <nav class="navbar navbar-expand-lg " id="nav">
      <a class="navbar-brand title mx-4" href="#"><h2 class="" id="kids">KIDS<span>PLANET. </span></h2></a>
      ...
      <li class="nav-item active  px-3 ">
       ...
       <?php
                 ...
                 if(!isset($_SESSION['username'])){
                   ...
                   <a class='nav-link '  href='./users/register.php' id='subText'>Register</a>
                 </li>
                 ";
                 }else{
                  echo "<li class='nav-item px-3'>
                  <a class='nav-link ' id='subText' href='./users/myprofile.php'>My Account</a>
                </li>
                ";
                 }
                 ...
                 // $cnt= $_SESSION['count'];
                  if(!isset($_SESSION['username'])){
                    ...
                    echo "<li class='nav-item  '>
                      <a class='nav-link' text-dark id='subText'  href='cart.php'><i class='fa-solid fa-cart-shopping'></i> <sup>0</sup></a> </li>";

                  }else{
                    echo "<li class='nav-item  '>
                     <a class='nav-link ' id='subText'  href='cart.php'> <i class='fa-solid fa-cart-shopping'></i> <sup>$_SESSION[count] </sup> </a></li>";
      ...
      <li class="nav-item px-2">
              ...
              <?php
                  ...
                  if(!isset($_SESSION['username'])){
                    ...
                    echo "<li class='nav-item '>
                      <a class='nav-link ' id='subText'  href='#'>Total: 0/- </a> </li> ";
                  }else{
                    echo "<li class='nav-item '>
                    <a class='nav-link ' id='subText' href='#'>Total:  $_SESSION[tot]/-</a></li>";
                  }
          ...
          <?php
                  if(!isset($_SESSION['username'])){
                    echo "<li class='nav-item px-1 '>
                      <a class='nav-link  text-primary' id='subText' href='./users/log.php'> Log In Here!</a></li>";
                  }else{
                    echo "<li class='nav-item px-1'>
                      <a class='nav-link text-primary' id='subText' href='./users/logout.php'>Log Out</a> </li>";
                  }
                ?>
...
<!-- SECOND -->
<nav class="navbar navbar-expand-lg navbar-dark mt-2 " id="#navTwo">
         ...
         <?php
            ...
            if(isset($_GET['product'])){
                $info=$_GET['data'];
                  ...
                  echo "<h4 class='mt-4'>Search results for  '$info'</h4> ";
                
                  $db = mysqli_connect("localhost", "root", "", "project");
                  $search="select * from toys where  category like '%$info%' or description like '%$info%' or name like '%$info%'";
          ...
          $rowToys=mysqli_fetch_assoc($resultToys);
              ...
              if($remainingStock==0){
                ...
                if($rowAmounts>0){
                  ...
                  echo "<script>window.open('searching.php','_self')</script>";
                }
              }
        }
